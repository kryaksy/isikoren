export const sampleAPI = {
  ...
  pitch: {
    ...
    title: "Biz rekabete karşıyız.",
    text:
      "Bizce rekabet sadece sporda vardır. İş hayatında rekabet edip rakibe benzeyerek aynılaşmak yerine yeni bir kulvar açarak farklılaşmaya, liderlik etmeye inanırız."
  },
  ads: {
    OnNumaraMotivasyon: {
      media: {
  ...
  team: [
    {
      ...
      snippet:
        "1997 – 2010 tarihleri arasında uluslararası üç gayrimenkul markasındaki üst düzey yöneticilik deneyimiyle de gayrimenkul ve inşaat sektörün önde gelen ismidir.",
      intro:
        "29 yıllık tecrübesiyle gıda, teknoloji, gayrimenkul gibi birçok alanda pek çok şirketin markalaşma süreçlerine liderlik eden Hilmi Işıkören Işıkören Danışmanlık şirketinin kurucu ortağıdır. 1997 – 2010 tarihleri arasında uluslararası üç gayrimenkul markasındaki üst düzey yöneticilik ve kurucu ortaklık deneyimiyle de gayrimenkul ve inşaat sektörünün önde gelen ismidir. Her yıl binden fazla kişiye eğitim veren Hilmi Işıkören, 10 Numara Motivasyon kitabı ve blog sayfasındaki iş ve hayata dair ilham veren, yol gösterici paylaşımlarıyla da tanınmakta, üniversite, şirket ve kurumlar için başarı üzerine motivasyon konuşmaları yapmaktadır.",
      bio: {
        title: "Biyografi",
        text:
          "1988 yılında Marmara Üniversitesinden mezun olduktan sonra franchising sistemini öğrenmek amacıyla Amerika’ya giden Hilmi Işıkören, döndüğünde gıda sektöründeki bir dünya markasının Türkiye merkezinde franchise direktörü olarak profesyonel yaşantısına başladı. Türkiye’nin ilk teknoloji marketinin markalaşma ve yaygınlaşma çalışmalarının içinde yer alarak markayı 3 yıl içerisinde 100 franchise mağazayla ülkenin en yaygın zinciri haline getirdi. 1997 – 2010 yılında arasında üç uluslararası gayrimenkul markasında (RE/ MAX Türkiye – Century 21 Türkiye – Realty World Türkiye) direktörlük, kurucu ortaklık ve genel müdürlük yapan Hilmi Işıkören, 2010 yılında kendi danışmanlık şirketini iletişim, pazarlama ve markalaşma konusunda uzman Belgin Benek ile birlikte kurdu. Sektör ayrımı yapmaksızın işinde başarılı olmak isteyen şirketleri, kurumları ve hatta bireyleri farklılaştırarak öne çıkarmak amacıyla danışmanlık, eğitim ve seminerler veren Işıkören ayrıca başarı üzerine ülke çapında gerçekleştirdiği ve yaygınlaştırdığı farklı ve etkileyici motivasyon konuşmalarıyla tanınmakta, blog ve köşe yazarlığı yapmaktadır. Hilmi Işıkören’in ilk kitabı “10 Numara Motivasyon” 29 Eylül 2016’da raflardaki yerini aldı. Çalışandan patrona herkes için ilham kaynağı olacak kitap, sadece iş dünyasıyla sınırlı kalmayarak, herkesin hayatına dokunan, kişisel gelişimi destekleyici bir yol haritasını da içeriyor. Kitabın geliri, korunmaya muhtaç çocuklara kucak açan “Koruncuk Vakfı”na bağışlayan Hilmi Işıkören, sonraki kitaplarında da bunu sürdürmeyi hedefliyor."
      },
      history: {
        title: null,
        all: [
          {
            date: "1990 - 1994",
            name: "Baskin Robbins Türkiye",
            position: "Franchise Müdürü"
          },
          {
            date: "1994 - 1997",
            name: "Escortland Türkiye",
            position: "Franchise Müdürü"
          },
          {
            date: "1997 - 2001",
          ...
          {
            date: "2005 - 2010",
            name: "Realty World Türkiye",
            position: "Kurucu Ortak / Genel Müdür"
          },
          {
            date: "2008 - 2012",
            name: "BÜYEM Gayrimenkul Danışmanlığı Sertifika Programı",
            position: "Kurucu / Eğitmen"
          },
          {
            date: "2010",
            name: "Işıkören Danışmanlık",
            position: "Kurucu Ortak / Danışman, Eğitmen, Yazar ve Konuşmacı"
          },
          {
            date: "2012",
            name: "Hürriyet Yazar Kafe",
            position: "Yazar"
          },
          {
            date: "2013",
            name: "Başarı ve Motivasyon Konuşmacısı",
            position: "Konuşmacı"
          },
          {
            date: "2016",
            name: "10 Numara Motivasyon kitabı",
            position: "Yazar",
            note:
              "Yazar geliri, korunmaya muhtaç çocuklar için Koruncuk Vakfına bağışlanmıştır."
          },
          {
            date: "2018",
            name: "Emlakta Lider Geliştirme Programı",
            position: "Kurucu / Eğitmen"
          }
        ]
      },
      educations: {
        ...
        all: [
          {
            name: "BR Academy, İş İdaresi Eğitim Programı",
            info: "LA, Glandale, ABD. 1992-1993",
            all: [
          ...
          },
          {
            ...
            info: "Denver, Colorado, ABD. 1997-1999",
            all: [
          ...
          {
            name: "Century 21 International",
            info: "Parsippany, New Jersey, ABD. 2001-2005",
            all: [
          ...
          {
            name: "Realty World International",
            info: "Costa Mesa, California, ABD. 2005-2010",
            all: [
    ...
    },
    {
      ...
      snippet:
        "Işıkören Danışmanlık şirketinin kurucu ortağı Belgin Benek, iletişim ve pazarlama konusunda uzmanlığının yanı sıra yetişkin eğitimcisi olarak da mesleki yetkinliğe sahiptir.",
      intro:
        "Işıkören Danışmanlık şirketinin kurucu ortağı Belgin Benek, iletişim ve pazarlama konusunda uzmanlığının yanı sıra yetişkin eğitimcisi olarak da mesleki yetkinliğe sahiptir. Yurt içi ve yurt dışı çalışmalarla hakim olduğu alanları sürekli geliştiren Belgin Benek bu konularla ilgili iki kez Japonya’ya gidip Toyota üretim sistemindeki yalın bakış açısını incelemiş ve Işıkören Danışmanlık bünyesindeki danışmanlık ve eğitim programlarına uyarlamıştır. Belgin Benek, 17 yıllık deneyimiyle iletişim, satış yükselten pazarlama danışmanlığı, satış eğitim ve koçluk programlarının hazırlanması ve sunumunda etkin rol oynamaya, 2017 yılı başından itibaren üniversitelerde iletişim üzerine konuşmalar yapmaya devam etmektedir.",
      bio: {
        name: "Biyografi",
        text:
          "2001 yılında Anadolu Üniversitesi İletişim Bilimleri Fakültesi, Eğitim İletişimi ve Planlaması bölümünü bitirerek iş dünyasına adımını atan Belgin Benek, ilk iş deneyimine İpbüken Danışmanlık (şimdiki Yalın Enstitü Derneği) bünyesinde Dünya Bankası ile ortak yürütülen “Nakliye ve Gümrük Yönetimi” projesiyle başladı. Sonrasında sosyal sorumuluk projeleri yürüten bir ajansta Tetrapak, Eczacıbaşı İpek Kağıt ve İpragaz firmalarına hizmet veren Benek, 2005 yılında Realty World Türkiye’de Kurumsal İletişim ve Franchise Müdürü olarak kariyerine devam etti. Burada Hilmi Işıkören ile tanışarak emlak/franchising ve bayi yönetimi konularında bilgi birikimini derinleştirmeye başlayan Belgin Benek, 2005-2009 yılları arasında birçok franchise ofis sahibi ve danışmanına eğitimler vererek, organizasyonlar düzenledi. Belgin Benek, 2010 yılında kendi danışmanlık şirketini iletişim, pazarlama ve markalaşma konusunda uzman Hilmi Işıkören ile birlikte kurdu. Japonya’da incelediği Toyota üretim sistemindeki yalın bakış açısını markalaşma, danışmanlık ve eğitim programlarına uyarladı. Benek, sektör ayrımı yapmaksızın işinde başarılı olmak isteyen şirketleri, kurumları ve hatta bireyleri farklılaştırarak öne çıkarmak amacıyla danışmanlık, eğitim ve seminerler vermeye devam etmektedir. Hilmi Işıkören’in 2016’da yayınlanan ilk kitabı “10 Numara Motivasyon” kitabının editörlüğünü de üstelenen Benek www.10numaramotivasyon.com’da sektörel ve sinema yazıları yazmaktadır."
      }
    }
  ],
  story: {
    ...
    intro: [
      "Mutluluk halimiz müşterilerimize, dostlarımıza ve çevremizdeki insanlara da yansıyacak, onların hayatlarında da olumlu değişiklikler yaratabilecektik. İşte bu bizim için başarı demekti. Yeteneklerimiz ve uzmanlıklarımız doğrultusunda insanlara yol göstermeyi, bilgilerimizi paylaşarak onlarla birlikte çoğalmayı, daha fazla öğrenmeyi, öğrendikçe değişmeyi, değiştikçe gelişmeyi hedefledik.",
      "Hayata olumlu bakan, gerçekçi iyimser kimliğimiz ve mutlu ruh halimizin avantajlarını cebimize koyarak 2010 yılında yola çıktık. Düşüncelerimize duygularımızı katarak eyleme geçtik. Bir nedenimiz vardı. Bildiğimiz, inandığımız ve sevdiğimiz şeyleri yaparsak mutlu kalacaktık."
    ],
    ourJob: {
      title: "İşimiz",
      text:
    ...
    ourFocus: {
      title: "Odağımız",
      text:
        "Geliştirdiğimiz stratejiler, mevcut ve sıklıkla daralan piyasalarda talebi bölmek ve rakipleri ölçmek yerine, talebi arttırmak ve rekabetten uzaklaşmakla ilgilidir. Gereksiz maliyetleri azaltıp karlılığı arttırmakla sonuçlanan hizmetlerimiz yalnızca kazandırmaya odaklıdır."
    },
    ourChallenges: {
      title: "Meydan okuruz",
      text:
  ...
  services: [
    {
      ...
      content: [
        ...
        "Sosyal medyayı emlakta bölge liderliği için yeniden yapılandırmak,",
      ...
      requirements: {
        ...
        bireysel: [
          "Program toplamda 36 saatten oluşur.",
    ...
    },
    {
      ...
      valueProposition: {
        title:
          "İnşaat projenizdeki satış ofisiniz için eğitim mi almak istiyorsunuz?",
        text:
    ...
    },
    {
      ...
      valueProposition: {
        title: "Markalaşmak mı istiyorsunuz?",
        text:
    ...
    },
    {
      ...
      valueProposition: {
        title: "İnşaat firmanız için danışmanlık mı almak istiyorsunuz?",
        text:
    ...
    },
    {
      ...
      valueProposition: {
        title: "Emlak ofisiniz için eğitim mi almak istiyorsunuz?",
        text:
      ...
      content: [
        ...
        "Emlakta müşterinin satın alma davranışlarını öğrenip ikna sürecini hızlandırmayı keşfedeceğiz,",
        "Müşterilerin itirazlarına karşı yapabileceklerimizi öğreneceğiz,",
        "Müşteri düşünelim derse ne diyerek satışı kapatmaya götürebileceğimizi göreceğiz,",
        "Projemizde satışlarımızı yükseltmenin 13 yolunu keşfedeceğiz,",
        "Sosyal medyayı profesyonel kullanarak fark yaratacağız,",
    ...
    },
    {
      ...
      valueProposition: {
        title: "Motivasyon üzerine seminer mi almak istiyorsunuz?",
        text:
