          ...
          <div className="info">
            ...
            <div className="container">
              ...
              <ul className="content list">
                ...
                <li className="item">
                  <p className="name">
                    Hedeflerinizi bölge liderliği için bilimsel yöntemlerle
                    yeniden planlamak,
                  </p>
                </li>
                <li className="item">
                ...
                <li className="item">
                  <p className="name">
                    Danışmanların müşterilerine liderlik etmesi, ofis
                    sahiplerinin danışmanlara liderlik etmesi üzerine
                    stratejiler geliştirmek,
                  </p>
                </li>
                <li className="item">
                  <p className="name">
                ...
                <li className="item">
                  <p className="name">
                    Portföyler üzerine değer tuvali çalışmasıyla birinci el,
                    proje ve ikinci el emlak satışlarında bölgenin lideri olmak,
                  </p>
                </li>
                <li className="item">
                  <p className="name">
                    Emlakta satış kapatmanın sırlarını öğrenerek bölgenizin
                    lideri olmak,
                  </p>
                </li>
              </ul>
              <ul className="requirements list">
                ...
                <li className="item">
                  ...
                  bitirebilirsiniz. Örneğin haftada bir gün 3 saat alınırsa,
                  ayda 12 saatten 3 ayda programı tamamlamak mümkün olabilir.
                </li>
                <li className="item">
                ...
                <li className="item">
                  Emlak ofisi sahibi olarak sizin Emlakta Lider Geliştirme
                  Programı sözleşmesini imzalayarak toplam 36’ı saate
                  katılacağınızı taahhüt etmeniz ve yarım bıraktığınız takdirde
                  kalan saatlerin bedelini ödemeyi kabul etmeniz gereklidir.
                </li>
                <li className="item">
                  Emlakta Lider Geliştirme Programı rekabete duyarlıdır.
                  Programa katılan bir emlak ofisi 36 saatlik programı
                  tamamlayıncaya dek ofisinin bulunduğu yerden 1 km yarıçaplı
                  daire içerisinde başka bir emlak ofisine aynı programın
                  verilmeyeceği tarafımızdan sözleşmede taahhüt edilir, aksi
                  durumda programın bedeli kadar cezai yaptırım kabul edilir.
                </li>
                <li className="item">
                  Emlakta Lider Geliştirme Programı’na katılan katılımcılara
                  bölgesinde lider olmaya hak kazandığının nişanesi olarak
                  Işıkören Danışmanlık onaylı katılım belgesi verilir. Katılım
                  belgesi olan lider ofis ve danışmanlar Işıkören Danışmanlığın
                  ya da kendilerinin geliştirdiği bireysel ve kurumsal
                  portföylerden paylaşım yapabilecekleri bir networkün içinde
                  yer alırlar.
                </li>
              </ul>
