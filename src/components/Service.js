  ...
  render() {
    return (
      <div className="service">
        ...
        <h2 className="title">Emlakta Lider Geliştirme Programı</h2>
        <p className="intro">
        ...
        <ul className="content list">
          ...
          <li className="item">
            <div className="line" />
            <p className="name">
              Sosyal medyayı emlakta bölge liderliği için yeniden yapılandırmak,
            </p>
          </li>
          <li className="item">
            <div className="line" />
            <p className="name">
              Emlakta telefonda etkili iletişim biçimlerini öğrenerek liderliğe
              uzanmak,
            </p>
          </li>
          <li className="item">
          ...
          <li className="item">
            <div className="line" />
            <p className="name">
              Portföyler üzerine değer tuvali çalışmasıyla birinci el, proje ve
              ikinci el emlak satışlarında bölgenin lideri olmak,
            </p>
          </li>
          <li className="item">
            <div className="line" />
        ...
        <ul className="requirements list">
          ...
          <li className="item">
            Programın katılımı 25 ile sınırlıdır. Bir emlak ofisinin bu sayının
            üzerinde katılımcısı olması durumunda yeni bir program açılır ve
            ayrıca ücretlendirilir.
          </li>
          <li className="item">
            36 saatlik program hafta içi bir gün, günde 3 saat olmak üzere ayda
            bir günden 1 yıla yayılmaktadır. Ancak emlak ofisi sahibi olarak
            programı daha yoğun hale getirebilir, daha kısa sürede
            bitirebilirsiniz. Örneğin haftada bir gün 3 saat alınırsa, ayda 12
            saatten 3 ayda programı tamamlamak mümkün olabilir.
          </li>
          <li className="item">
            Emlak ofisinizin Ticaret Odasına ya da Emlak Odasına kayıtlı olması
            gereklidir.
          </li>
          <li className="item">
          ...
          <li className="item">
            ...
            ofisinin bulunduğu yerden 1 km yarıçaplı daire içerisinde başka bir
            emlak ofisine aynı programın verilmeyeceği tarafımızdan sözleşmede
            taahhüt edilir, aksi durumda programın bedeli kadar cezai yaptırım
            kabul edilir.
          </li>
          <li className="item">
            ...
            lider ofis ve danışmanlar Işıkören Danışmanlığın ya da kendilerinin
            geliştirdiği bireysel ve kurumsal portföylerden paylaşım
            yapabilecekleri bir networkün içinde yer alırlar.
          </li>
        </ul>
