    ...
    return (
      <div className="App-about">
        ...
        <div>
          ...
          <p className="intro">
            Sektör ayrımı yapmaksızın işinde başarılı olmak isteyen şirketleri,
            kurumları ve hatta bireyleri farklılaştırarak öne çıkarmak amacıyla
            danışmanlık, eğitim ve seminerler veririz.
          </p>
          ...
          <p className="intro">
            ...
            yardımcı olur, yol gösteririz. Müşterilerimizle birlikte inovasyonu
            esas alarak performans arttırmak ve rekabet gücünü yenilemek
            konusunda programlı bir çalışma yürütürüz.
          </p>
